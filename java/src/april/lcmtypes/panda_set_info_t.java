...
public final class panda_set_info_t implements lcm.lcm.LCMEncodable
{
    public long utime;
    ...
    public int feature_min[];
    public int feature_max[];
    public int features[];
 
    public panda_set_info_t()
    {
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0x2687a60d864f35cbL;
    ...
    {
        if (classes.contains(april.lcmtypes.panda_set_info_t.class))
            return 0L;
 
        classes.add(april.lcmtypes.panda_set_info_t.class);
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        for (int a = 0; a < this.num_of_features; a++) {
            outs.writeInt(this.feature_min[a]); 
        }
 
        for (int a = 0; a < this.num_of_features; a++) {
            outs.writeInt(this.feature_max[a]); 
        }
 
        for (int a = 0; a < this.num_of_features; a++) {
            outs.writeInt(this.features[a]); 
        }
 
    }
 
    public panda_set_info_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public panda_set_info_t(DataInput ins) throws IOException
    {
    ...
    public static april.lcmtypes.panda_set_info_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        april.lcmtypes.panda_set_info_t o = new april.lcmtypes.panda_set_info_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.feature_min = new int[(int) num_of_features];
        for (int a = 0; a < this.num_of_features; a++) {
            this.feature_min[a] = ins.readInt();
        }
 
        this.feature_max = new int[(int) num_of_features];
        for (int a = 0; a < this.num_of_features; a++) {
            this.feature_max[a] = ins.readInt();
        }
 
        this.features = new int[(int) num_of_features];
        for (int a = 0; a < this.num_of_features; a++) {
            this.features[a] = ins.readInt();
        }
 
    }
 
    public april.lcmtypes.panda_set_info_t copy()
    {
        april.lcmtypes.panda_set_info_t outobj = new april.lcmtypes.panda_set_info_t();
        ...
        outobj.feature_min = new int[(int) num_of_features];
        if (this.num_of_features > 0)
            System.arraycopy(this.feature_min, 0, outobj.feature_min, 0, this.num_of_features); 
        outobj.feature_max = new int[(int) num_of_features];
        if (this.num_of_features > 0)
            System.arraycopy(this.feature_max, 0, outobj.feature_max, 0, this.num_of_features); 
        outobj.features = new int[(int) num_of_features];
        if (this.num_of_features > 0)
            System.arraycopy(this.features, 0, outobj.features, 0, this.num_of_features); 
        return outobj;
    }
