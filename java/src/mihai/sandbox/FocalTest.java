 ...
 */
public class FocalTest implements ParameterListener
{
    ...
    public FocalTest(String url, boolean hiRes, boolean gray8, int fps)
    {
        pg = new ParameterGUI();
        pg.addButtons("Reset", "toggle image source");
        pg.addDoubleSlider("fcx", "fcx", 300, 700, 477);
        pg.addDoubleSlider("fcy", "fcy", 300, 700, 477);
        pg.addListener(this);
    ...
    class Image extends Thread
    {
        ...
        public void run()
        {
            ...
            while (true)
            {
                ...
                if(tags.size()==2)
                {
                    double[][] M1 = CameraUtil.homographyToPose(pg.gd("fcx"), pg.gd("fcy"), 0.152, tags.get(0).homography);
                    double[][] M2 = CameraUtil.homographyToPose(pg.gd("fcx"), pg.gd("fcy"), 0.152, tags.get(1).homography);
//                    double[] M1toM2 = LinAlg.matrixToXyzrpy(LinAlg.matrixAB(M1, LinAlg.inverse(M2)));
    ...
    public static void main(String[] args)
    {
        ...
        new FocalTest(opts.getString("url"), opts.getString("resolution").contains("hi"), opts.getString( "colors").contains("8"), opts.getInt("fps"));
    }
