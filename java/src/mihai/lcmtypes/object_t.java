...
public final class object_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(mihai.lcmtypes.object_t.class))
            return 0L;
 
        classes.add(mihai.lcmtypes.object_t.class);
    ...
    public static mihai.lcmtypes.object_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        mihai.lcmtypes.object_t o = new mihai.lcmtypes.object_t();
    ...
    public mihai.lcmtypes.object_t copy()
    {
        mihai.lcmtypes.object_t outobj = new mihai.lcmtypes.object_t();
        outobj.id = this.id;
