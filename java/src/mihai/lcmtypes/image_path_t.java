...
public final class image_path_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(mihai.lcmtypes.image_path_t.class))
            return 0L;
 
        classes.add(mihai.lcmtypes.image_path_t.class);
    ...
    public static mihai.lcmtypes.image_path_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        mihai.lcmtypes.image_path_t o = new mihai.lcmtypes.image_path_t();
    ...
    public mihai.lcmtypes.image_path_t copy()
    {
        mihai.lcmtypes.image_path_t outobj = new mihai.lcmtypes.image_path_t();
