...
public final class led_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(mihai.lcmtypes.led_t.class))
            return 0L;
 
        classes.add(mihai.lcmtypes.led_t.class);
    ...
    public static mihai.lcmtypes.led_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        mihai.lcmtypes.led_t o = new mihai.lcmtypes.led_t();
    ...
    public mihai.lcmtypes.led_t copy()
    {
        mihai.lcmtypes.led_t outobj = new mihai.lcmtypes.led_t();
