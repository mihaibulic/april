...
public final class image_path_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(discovery.lcmtypes.image_path_t.class))
            return 0L;
 
        classes.add(discovery.lcmtypes.image_path_t.class);
    ...
    public static discovery.lcmtypes.image_path_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        discovery.lcmtypes.image_path_t o = new discovery.lcmtypes.image_path_t();
    ...
    public discovery.lcmtypes.image_path_t copy()
    {
        discovery.lcmtypes.image_path_t outobj = new discovery.lcmtypes.image_path_t();
