...
public class CameraCalibration implements ParameterListener
{
    ...
    public CameraCalibration(String url, boolean hiRes, boolean gray8, int fps)
    {
        pg = new ParameterGUI();
        pg.addListener(this);
    ...
    public static void main(String[] args)
    {
        ...
        new CameraCalibration(opts.getString("url"), opts.getString("resolution").contains("hi"), opts.getString( "colors").contains("8"), opts.getInt("fps"));
    }
